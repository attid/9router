...
export default function TranslatorPage() {
  ...
  const handleLoad = async (stepId) => {
    ...
    try {
      const res = await fetch(withBasePath(`/api/translator/load?file=${step.file}`));
  ...
  const detectMeta = async (rawContent) => {
    try {
      ...
      const res = await fetch(withBasePath("/api/translator/translate"), {
        method: "POST",
  ...
  const save = (file, content) => fetch(withBasePath("/api/translator/save"), {
    method: "POST",
    headers: { "Content-Type": "application/json" },
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const res = await fetch(withBasePath("/api/translator/send"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      await fetch(withBasePath("/api/translator/save"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
