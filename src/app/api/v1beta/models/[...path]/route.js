...
export async function POST(request, { params }) {
  ...
  try {
    ...
    // Keep the native body so the shared translator preserves tools and multimodal parts.
    body.model = model;
    ...
    const aggregated = aggregateGeminiSSE(await response.text());
    if (!aggregated.modelVersion) aggregated.modelVersion = model;
