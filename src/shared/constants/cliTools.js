...
export const MITM_TOOLS = {
  antigravity: {
    id: "antigravity",
    name: "Antigravity",
    image: apiPath("/providers/antigravity.png"),
    color: "#4285F4",
  ...
  copilot: {
    id: "copilot",
    name: "GitHub Copilot",
    image: apiPath("/providers/copilot.png"),
    color: "#1F6FEB",
  ...
  kiro: {
    id: "kiro",
    name: "Kiro",
    image: apiPath("/providers/kiro.png"),
    color: "#FF6B00",
  ...
  //   id: "cursor",
  //   name: "Cursor",
  //   image: apiPath("/providers/cursor.png"),
  //   color: "#000000",
...
export const CLI_TOOLS = {
  claude: {
    id: "claude",
    name: "Claude Code",
    image: apiPath("/providers/claude.png"),
    color: "#D97757",
  ...
  openclaw: {
    id: "openclaw",
    name: "Open Claw",
    image: apiPath("/providers/openclaw.png"),
    color: "#FF6B35",
  ...
  codex: {
    ...
    image: apiPath("/providers/codex.png"),
    color: "#10A37F",
  ...
  opencode: {
    id: "opencode",
    name: "OpenCode",
    image: apiPath("/providers/opencode.png"),
    color: "#E87040",
  ...
  hermes: {
    id: "hermes",
    name: "Hermes Agent",
    image: apiPath("/providers/hermes.png"),
    color: "#8B5CF6",
  ...
  droid: {
    id: "droid",
    name: "Factory Droid",
    image: apiPath("/providers/droid.png"),
    color: "#00D4FF",
  ...
  cline: {
    id: "cline",
    name: "Cline",
    image: apiPath("/providers/cline.png"),
    color: "#00D1B2",
  ...
  kilo: {
    id: "kilo",
    name: "Kilo Code",
    image: apiPath("/providers/kilocode.png"),
    color: "#FF6B6B",
  ...
  roo: {
    id: "roo",
    name: "Roo",
    image: apiPath("/providers/roo.png"),
    color: "#FF6B6B",
  ...
  continue: {
    id: "continue",
    name: "Continue",
    image: apiPath("/providers/continue.png"),
    color: "#7C3AED",
  ...
  amp: {
    id: "amp",
    name: "Amp CLI",
    image: apiPath("/providers/amp.png"),
    color: "#F97316",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  qwen: {
    id: "qwen",
    name: "Qwen Code",
    image: apiPath("/providers/qwen.png"),
    color: "#10B981",
  ...
  "deepseek-tui": {
    id: "deepseek-tui",
    name: "DeepSeek TUI",
    image: apiPath("/providers/deepseek-tui.png"),
    color: "#4D6BFE",
  ...
  jcode: {
    id: "jcode",
    name: "jcode",
    image: apiPath("/providers/jcode.png"),
    color: "#FF6B35",
