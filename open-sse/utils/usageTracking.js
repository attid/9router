 ...
 */
export function logUsage(provider, usage, model = null, connectionId = null, apiKey = null, usageMeta = null) {
  ...
  saveRequestUsage({
    ...
    requestedModel: usageMeta?.requestedModel || undefined,
    metered: usageMeta?.metered,
  }).catch(() => { });
