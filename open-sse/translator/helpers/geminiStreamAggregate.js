/**
 * Collapse a Gemini SSE stream (data: {...} lines) into a single
 * GenerateContentResponse, for non-streaming :generateContent requests.
 *
 * Text parts are concatenated; functionCall parts are preserved as-is.
 * finishReason, usageMetadata and modelVersion are taken from the chunks
 * that carry them (last one wins).
 */
