...
vi.mock("@/lib/basePath", async () => vi.importActual("../../src/lib/basePath.js"));
...
function fakeRequest(pathname, { token } = {}) {
  return {
    ...
    headers: {
      get: (name) => {
        if (String(name).toLowerCase() === "host") return "localhost:20128";
        return "";
      },
    },
  };
...
async function loadGuard(env = {}) {
  ...
  vi.doMock("@/lib/basePath", async () => vi.importActual("../../src/lib/basePath.js"));
